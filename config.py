...
ACCTIFNO_LIST = [
    # [
    #     { 'acct': 'h1', 'server': 'zh1_z2', 'status': False, 'coor': 'zh1' },
    #     { 'acct': 'h2', 'server': 'zh2_z2', 'status': False, 'coor': 'zh2' },
    #     { 'acct': 'h3', 'server': 'zh3_z2', 'status': False, 'coor': 'zh3' },
    #     { 'acct': 'h4', 'server': 'zh4_z2', 'status': False, 'coor': 'zh4' },
    #     { 'acct': 'h5', 'server': 'zh5_z2', 'status': False, 'coor': 'zh5' }
    # ],
    [
        { 'acct': 'h1', 'server': 'zh1_z4', 'status': False, 'coor': 'zh1' },
        { 'acct': 'h2', 'server': 'zh2_z4', 'status': False, 'coor': 'zh2' },
        { 'acct': 'h3', 'server': 'zh3_z4', 'status': False, 'coor': 'zh3' },
        { 'acct': 'h4', 'server': 'zh4_z4', 'status': False, 'coor': 'zh4' },
        { 'acct': 'h5', 'server': 'zh5_z4', 'status': False, 'coor': 'zh5' }
    ],
    # [
    #     { 'acct': 'h1', 'server': 'zh1_z3', 'status': False, 'coor': 'zh1' },
    #     { 'acct': 'h2', 'server': 'zh2_z3', 'status': False, 'coor': 'zh2' },
    #     { 'acct': 'h3', 'server': 'zh3_z3', 'status': False, 'coor': 'zh3' },
    #     { 'acct': 'h4', 'server': 'zh4_z3', 'status': False, 'coor': 'zh4' },
    #     { 'acct': 'h5', 'server': 'zh5_z3', 'status': False, 'coor': 'zh5' }
    # ]
]
